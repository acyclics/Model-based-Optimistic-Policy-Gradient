...
from mbopg.memory.segment_tree import SumTree, MinTree
...
class LazyPrioritizedMultiStepMemory(LazyMultiStepMemory):
    ...
    def __init__(self, capacity, state_shape, action_shape, device, gamma=0.99,
                 ...
                 min_pa=0.0, max_pa=1.0, eps=1e-5):
    ...
    def append(self, state, action, reward, next_state, done, done_no_max, p=None):
        # Calculate priority.
        if p is None:
            pa = self.max_pa
        else:
