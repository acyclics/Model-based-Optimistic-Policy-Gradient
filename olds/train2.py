...
from mbopg.mbrl2 import MBRL_solver
...
for loop_n in range(N_OVERALL_LOOPS):
    policy, critic = mbrl_solver.solve(network, dataset_state, dataset_action, dataset_rewards, dataset_next_states, dataset_dones, dataset_logprob, verbose=True)
