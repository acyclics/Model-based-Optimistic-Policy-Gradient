...
class PrimaryNetwork(nn.Module):
    ...
    def feedforward(self, obs, action, w):
        ...
        for i in range(w.shape[0]):
            ...
            next_state = F.linear(y, w_state[i], self.state_bias)
            reward = F.linear(y, w_reward[i], self.reward_bias)
            done = F.linear(y, w_done[i], self.done_bias)
...
class Multi_SI_BayesNetwork(nn.Module):
    ...
    def __init__(self, obs_units, act_units, obs_scalings, hidden_units=64,
                 ...
                 lr=1e-4, grad_norm=5.0, noise_dim=3, device='cpu'):
    ...
    def calculate_head_loss(self, z_J, combinedhypernetwork):
        ...
        hypernet_ws['hypernetwork_obs_w'] = hypernetwork_obs_w
        ...
        hypernet_ws['hypernetwork_act_w'] = hypernetwork_act_w
