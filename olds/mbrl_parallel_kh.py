...
class MBRL_solver(nn.Module):
    ...
    def _solve_once_critic(self, network, dataset_states, epsilon_greedy=False):
        initial_obs = []
    ...
    def _solve(self, network, dataset_states, verbose=True):
        for epoch in range(self.epochs):
            ...
            while critic_itrs < self.critic_min_iterations_per_epoch:
                critic_losses = self._solve_once_critic(network, dataset_states)
                critic_itrs += 1
